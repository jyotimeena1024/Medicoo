    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        <div className='flex flex-col gap-4 text-sm text-gray-600'>
            <p onClick={()=>speciality ==='General physician' ? navigate('/doctors') :navigate('/doctors/General physician')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "" ? "bg-indigo-100 text-"}`}>General physician</p>
            <p onClick={()=>speciality ==='Gyencologist' ? navigate('/doctors') :navigate('/doctors/Gyencologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer`}>Gyencologist</p>
            <p onClick={()=>speciality ==='Dermatalogist' ? navigate('/doctors') :navigate('/doctors/Dermatalogist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer`}>Dermatalogist</p>
